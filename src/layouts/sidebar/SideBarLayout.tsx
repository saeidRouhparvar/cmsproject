...
const SideBarLayout = () => {
  const sideList: any = Routes.filter((item) => item.path === "/*")[0].child;
  const [active, setActive] = useState(false);

  return (
    <Flex direction={"column"}  gap={"52px"} mt={"30px"}>
      <Flex me={"40px"} align={"center"} justify={"center"}>
        <svg
          width="50"
          height="50"
          viewBox="0 0 50 50"
